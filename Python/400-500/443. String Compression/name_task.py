...
instead, be stored in the input character array chars. Note
that group lengths that are 10 or longer will be
After you are done modifying the input array, return the
You must write an algorithm that uses only constant extra
